...
# Parallelization part, had to be done some of the hacks
...
ppo(ac_kwargs={'hidden_sizes': parameters.MODEL_HIDDEN_LAYERS_SIZES, 'activation': parameters.MODEL_ACTIVATION},
    ...
    enemies=parameters.ENEMIES_CHOSEN_FOR_TRAINING, enemies_difficulty=parameters.ENEMIES_DIFFICULTY, gamma=parameters.GAMMA, clip_ratio=parameters.CLIP_RATIO,
