...
if __name__ == '__main__':
    ...
    print('Training against ', enemies)
    ppo(ac_kwargs={'hidden_sizes': parameters.MODEL_HIDDEN_LAYERS_SIZES, 'activation': parameters.MODEL_ACTIVATION},
        ...
        enemies=enemies, enemies_difficulty=parameters.ENEMIES_DIFFICULTY, gamma=parameters.GAMMA, clip_ratio=parameters.CLIP_RATIO,
